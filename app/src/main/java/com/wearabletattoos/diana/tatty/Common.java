 ...
 *
 * Modified 2015 by Diana Lamaute
 *
 */
...
// ############################################################################
    ...
    public void onCreate() {
        ...
        /*<!--
                <meta-data
        android:name="com.backendless.APPLICATION_ID"
        android:value="FAC70125-3ADD-4880-FF6B-FF065C81F300" />
        <meta-data
        android:name="com.backendless.ANDROID_SECRET_KEY"
        android:value="BC13AD3C-241D-1E61-FF4D-E84E5DCAEE00" />
                -->*/
        Backendless.initApp(this, applicationID, androidSecretKey, appVersion);
